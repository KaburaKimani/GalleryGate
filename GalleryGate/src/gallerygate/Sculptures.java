...
public class Sculptures extends JPanel {
    ...
    public Sculptures(GalleryGate parent) {
        this.parent = parent;
        setLayout(new BorderLayout());
        setBackground(BABY_PINK);
        createSculpturesPage();
    }

    private void createSculpturesPage() {
        // Header
        JPanel headerPanel = new JPanel(new BorderLayout());
        headerPanel.setBackground(BABY_BLUE);
        headerPanel.setBorder(new EmptyBorder(20, 20, 20, 20));
        
        JLabel title = new JLabel("Sculptures Gallery", SwingConstants.CENTER);
        ...
        String[] sculptures = {"Marble Statues", "Bronze Figures", "Clay Models", 
                              "Wood Carvings", "Modern Sculptures", "Classical Art"};
        
        for (String art : sculptures) {
            contentPanel.add(createArtPanel(art, "Sculptures"));
        }
        ...
        JButton uploadButton = new JButton("Upload Sculpture");
        uploadButton.addActionListener(e -> uploadArt("Sculptures"));
