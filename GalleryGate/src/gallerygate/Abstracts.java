...
public class Abstracts extends JPanel {
    ...
    public Abstracts(GalleryGate parent) {
        this.parent = parent;
    ...
    private void createAbstractsPage() {
        // Header
        JPanel headerPanel = new JPanel(new BorderLayout());
        headerPanel.setBackground(BABY_BLUE);
        headerPanel.setBorder(new EmptyBorder(20, 20, 20, 20));
        
        JLabel title = new JLabel("Abstracts Gallery", SwingConstants.CENTER);
        ...
        String[] abstracts = {"Color Splash", "Geometric Patterns", "Fluid Art", 
                            "Digital Abstracts", "Mixed Media", "Textured Art"};
        
        for (String art : abstracts) {
            contentPanel.add(createArtPanel(art, "Abstracts"));
        }
        ...
        JButton uploadButton = new JButton("Upload Abstract Art");
        uploadButton.addActionListener(e -> uploadArt("Abstracts"));
