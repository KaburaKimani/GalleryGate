...
public class Animals extends JPanel {
    ...
    public Animals(GalleryGate parent) {
        this.parent = parent;
    ...
    private void createAnimalsPage() {
        // Header
        JPanel headerPanel = new JPanel(new BorderLayout());
        headerPanel.setBackground(BABY_BLUE);
        headerPanel.setBorder(new EmptyBorder(20, 20, 20, 20));
        
        JLabel title = new JLabel("Animals Gallery", SwingConstants.CENTER);
        ...
        String[] animals = {"Wildlife Photography", "Pet Portraits", "Bird Watching", 
                          "Marine Life", "Insect Macro", "Animal Portraits"};
        
        for (String art : animals) {
            contentPanel.add(createArtPanel(art, "Animals"));
        }
        ...
        JButton uploadButton = new JButton("Upload Animal Art");
        uploadButton.addActionListener(e -> uploadArt("Animals"));
